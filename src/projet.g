...
vars  : 'var' ( type ident {PtGen.pt(10);} ( ','  ident {PtGen.pt(10);} )* ptvg )+ {PtGen.pt(8);}
  ;
...
boucle  : 'ttq' {PtGen.pt(34);} expression {PtGen.pt(35);}'faire' instructions {PtGen.pt(36);} 'fait' 
  ;
...
exp2  : 'non' {PtGen.pt(14);} exp2 {PtGen.pt(14);}{PtGen.pt(24);}
  | exp3  
  ;
